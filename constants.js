...
export const NAME = {
  ...
  PRIVACY_TECH: 'Privacy technologies',
  DATA_AGGREGATION: 'Oracle attestation - Data aggregation',
  CRYPT_PROOF: 'Oracle attestation - Cryptographic proofs',
  REP_SYS: 'Oracle attestation - Reputation system',
  IOT: 'IOT',
  SCALING_TECH: 'Scaling technologies',
  OFF_CHAIN: 'Off-chain storage',
