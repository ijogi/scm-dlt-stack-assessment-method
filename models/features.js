...
export default {
  ...
  getProtocolLayer: (value) => ({
    id: 'prot-l',
    name: NAME.PROTOCOL_LAYER,
    value,
    type: TYPE.REQ,
    description: `
      A DLT protocol provides the underluing software that defines the ledger architecture and consensus mechanism.
    `,
  }),
